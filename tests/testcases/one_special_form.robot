...
Library    DataDriver    file=${e2e_test_data_excel_file}    encoding=utf-8    dialect=unix    sheet_name=one_special_form
Test Template    One Special Form - Yes Agreement

*** Test Cases ***
One Special Form - Yes Agreement
    [Tags]    SB
...
One Special Form - Yes Agreement
    ...
    ...    ${active_supplier_address_value}    ${Reason_for_Donation_value}    ${region_for_recipient_value}
