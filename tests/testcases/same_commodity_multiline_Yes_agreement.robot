...
Library    DataDriver    file=${e2e_test_data_excel_file}     encoding=utf-8    dialect=unix   sheet_name=multiline_same_commodity

Test Template    Amount Based yes Agreement Basic Roundtrip multiline

*** Test Cases ***
Amount Based yes Agreement Basic Roundtrip multiline
    [Tags]    SB
