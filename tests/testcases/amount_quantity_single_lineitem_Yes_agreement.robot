...
Library    DataDriver    file=${e2e_test_data_excel_file}    encoding=utf-8    dialect=unix    sheet_name=main_scenario_yes
Test Template    Amount/Quantity Based - Yes Agreement

*** Test Cases ***
Amount/Quantity Based - Yes Agreement
    [Tags]    SRK
